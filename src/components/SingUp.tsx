...
class SingUp extends Component<any, any>{
    ...
    handleClickSkip() {
        ...
        if (hor.length === 0) {
            this.setState({ horario: [[{ inicio: null, fin: null }]], step: step + 1, isMas: false});
            return;
        }
    ...
    handleClickMas() {
        ...
        if (ini !== '' && fi !== '') {
            ...
            if (hor.length === 0) {
                this.setState({ horario: [[{ inicio: inicio, fin: final }]], isMas: true, temp: '', temp2: '' }); return;
            }
            ...
            if(this.state.isMas){
                ...
                this.setState({ horario: [...hor, [{ inicio: inicio, fin: final }]], temp: '', temp2: '', isMas: true });
            }
